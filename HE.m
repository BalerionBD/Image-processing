...
close;
% Read the image 
a=imread("D:\Matlab Program\Image Processing Codes\MMBEBHE\test2.PNG");
...
for j=1:b(2)%loop tracing these columns of image
   t=(a(i,j)+1);%pixel values in image
ep(i,j)=cdf(t);  %Making the output image using       cdf as the transformation function
    end                                             
end
% Loop for Getting the Histogram of the image
hist2 = zeros(1,256);
